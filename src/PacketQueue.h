...
protected:
	...
	std::shared_ptr<InsteonMessage> _message;
	std::shared_ptr<InsteonPacket> _packet;
public:
	bool stealthy = false;
	...
	std::shared_ptr<InsteonPacket> getPacket() { return _packet; }
	void setPacket(std::shared_ptr<InsteonPacket> packet, bool setQueueEntryType) { _packet = packet; if(setQueueEntryType) _type = QueueEntryType::PACKET; }
	std::shared_ptr<InsteonMessage> getMessage() { return _message; }
	void setMessage(std::shared_ptr<InsteonMessage> message, bool setQueueEntryType) { _message = message; if(setQueueEntryType) _type = QueueEntryType::MESSAGE; }
};
